...
impl Url {
    ...
    pub fn to_xml(self) -> Result<XMLElement, XMLError> {
        ...
        if let Some(canonical) = self.canonical {
            let mut canonical_link: XMLElement = XMLElement::new("xhtml:link");
            canonical_link.add_attribute("rel", "canonical");
            canonical_link.add_attribute("href", &canonical);
            url.add_child(canonical_link)?;
        }
...
mod tests {
    ...
    fn test_to_xml() {
        let url: Url = Url::builder(String::from("https://www.example.com/"))
            ...
            .canonical(String::from("https://www.example.com/"))
            .build()
        ...
        assert_eq!(
            ...
            <url>\n\
                ...
                \t<xhtml:link href=\"https://www.example.com/\" rel=\"canonical\" />\n\
            </url>\n",
            result
        );
    }
